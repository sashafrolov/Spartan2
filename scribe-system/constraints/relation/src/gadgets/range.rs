...
mod test {
    ...
    fn test_range_gate_helper<F: RawPrimeField>() -> Result<(), CircuitError> {
        ...
        *circuit.witness_mut(b) = F::from(1024u32);
        ...
        // independent
        let _ = build_range_gate_circuit(F::from(314u32))?;
        let _ = build_range_gate_circuit(F::from(489u32))?;
    ...
    fn test_check_in_range_helper<F: RawPrimeField>() -> Result<(), CircuitError> {
        ...
        *circuit.witness_mut(a) = F::from(1024u32);
        ...
        // the arithmetized extended permutation polynomial is variable
        // independent
        let _ = build_check_in_range_circuit(F::from(314u32))?;
        let _ = build_check_in_range_circuit(F::from(1489u32))?;

...
//! This implements an optimized version of the neutronnova_zk proof system from Spartan2.
//! These are mainly "engineering" optimizations that give a 10-20% speedup and aren't academically
  ...
  E::PCS: FoldingEngineTrait<E>,
{
  ...
  pub fn prove<C1: SpartanCircuit<E>, C2: SpartanCircuit<E>>(
    ...
    for (si, w, ri, av, bv, cv, hash) in step_tuples {
  ...
  pub fn verify(
    ...
    // validate the step instances and core instance in parallel

// NeutronNova video editing with the non-streaming version and T256 Hyrax commitments.
...
//
// Run with:
//   RUST_LOG=neutron_nova_hyrax_video_editing=info,spartan2::neutronnova_zk_ram_optimized=info RUSTFLAGS="-C target-cpu=native" cargo run --example neutron_nova_hyrax_video_editing --release
